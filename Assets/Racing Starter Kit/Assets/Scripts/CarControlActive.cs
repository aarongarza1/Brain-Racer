...
public class CarControlActive : MonoBehaviour
{
    ...
    private CarAIControlPF[] CarAIControlPFScripts;
    ...
    void Start()
    {
        ...
        CarAIControlPFScripts = FindObjectsOfType(typeof(CarAIControlPF)) as CarAIControlPF[];
        ...
        foreach (CarAIControl cc in CarAIControlScripts)
            cc.enabled = true;
        foreach (CarAIControlPF ccpf in CarAIControlPFScripts)
            ccpf.enabled = true;
